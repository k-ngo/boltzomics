...
METRIC_DESCRIPTIONS = {
    ...
    "conf": (
        ...
        "and reliability of the predicted protein-ligand complex structure. "
        "Confidence is computed as: 0.8 x pLDDT + 0.2 x ipTM, where pLDDT is normalized to 0-1 "
        "(the displayed Avg pLDDT value is on a 0-100 scale). Higher values indicate greater "
        "confidence in the structural prediction. Values > 0.7 are typically considered reliable."
    ),
    "ptm": (
